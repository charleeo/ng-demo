...
@Component({
  selector: 'app-stampobjections',
  templateUrl: './stampobjections.component.html',
  styleUrls: ['./stampobjections.component.css']
})
export class StampobjectionsComponent implements OnInit {
  roleID: string;
  title = "Stamp Duty - Objections";
  config: any;
  ...
  getAppeals(perpage, pageno) {
    ...
    this.apiUrl = `${environment.AUTHAPIURL}stamp-duty/assessment-appeals/list?page=${pageno}`;
  ...
  viewAppeal(modal, selectedAppeal) {
    ...
    this.selectedTaxpayerId = selectedAppeal.taxpayer_id;
  ...
  getSingleAppeal(appealId) {
    this.spinnerService.show();
    this.apiUrl = `${environment.AUTHAPIURL}stamp-duty/assessment-appeals/${appealId}`;
  ...
  loadSelectedAppealData(selectedAppeal) {
    ...
    this.appealForm = this.formBuilder.group({
      ...
      assessmentId: [selectedAppeal.stamp_duty_assessment_id],
    });
  ...
  onSubmitInvite(formAllData) {
    ...
    this.apiUrl = `${environment.AUTHAPIURL}stamp-duty/invite-for-meeting`;
  ...
  postApproveAppeal(jsonData: any) {
    this.spinnerService.show();
    this.apiUrl = `${environment.AUTHAPIURL}stamp-duty/assessment-appeals/approve`;
  ...
  pageChange(newPage: number) {
    this.appealsData = "";
    this.router.navigate(["/stampobjections"], {
