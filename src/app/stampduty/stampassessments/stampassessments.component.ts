...
@Component({
  selector: 'app-stampassessments',
  templateUrl: './stampassessments.component.html',
  styleUrls: ['./stampassessments.component.css']
})
export class StampassessmentsComponent implements OnInit {
  apiUrl: string;
  assessmentsData: any;
  searchObject: any = {};
  title = "Stamp Duty - Assessments";
  dtOptions: any = {};
  dtOptionsPopUp: any = {};
  ...
  getAssessments(perpage, pageno) {
    ...
    this.apiUrl = `${environment.AUTHAPIURL}stamp-duty/get_assessment/lists?page=${pageno}`;
  ...
  viewAssessment(modal, selectedAssessment) {
    ...
    this.selectedTaxpayerId = selectedAssessment.taxpayer_id;
    this.primaryTaxpayerId = selectedAssessment.taxpayer_primary_id;
  ...
  getSingleAssessment(assessmentId) {
    ...
    this.apiUrl = `${environment.AUTHAPIURL}stamp-duty/get_assessment_details/${assessmentId}`;
    ...
    this.httpClient.get<any>(this.apiUrl, { headers: reqHeader }).subscribe((data) => {
        ...
        this.assessmentUpdatesData = data.response.assessment_updates == null ? [] : data.response.assessment_updates;
  ...
  loadSelectedAssessmentData(selectedAssessment) {
    ...
    let amountToPay = selectedAssessment.tax_amount;
  ...
  processInvoice() {
    ...
    const obj = {
      collector_id: this.primaryTaxpayerId,
      collector_taxpayer_id: this.selectedTaxpayerId,
      stamp_duty_assessment_id: this.selectedAssessmentId,
    };
  ...
  postGenerateObjection(jsonData: any) {
    this.spinnerService.show();
    this.apiUrl = `${environment.AUTHAPIURL}stamp-duty/assessment-appeals/add`;
...
////////////////////////////////////////////////// Objection Ends ///////////////////////////////////////////
  ...
  pageChange(newPage: number) {
    ...
    this.router.navigate(['/stampassessments'], { queryParams: { page: newPage } });
  ...
  public setItemsPerPage(event) {
    ...
    this.assessmentsData = '';
    this.router.navigate(['/stampassessments']);
