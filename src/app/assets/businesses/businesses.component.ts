...
export class BusinessesComponent implements OnInit {
  ...
  addBusinessModalRef: any;
  viewBusinessModalRef: any;
  ...
  showLinkTaxpayerButton: boolean;
  linkTaxpayerModalRef: any;
  selectedIndividualId: any;
  assetTypeId: any = 1; // Business
  managerRole: boolean;
  ...
  pageChange(newPage: number) {
    this.businessesData = "";
    this.router.navigate(["/businesses"], { queryParams: { page: newPage } });
  ...
  addBusiness(modal) {
    this.addBusinessModalRef = this.utilityService.openModal(modal);
  }
  ...
  viewBusiness(modal, selectedBusiness) {
    ...
    this.getLinkedTaxpayerData();
    this.viewBusinessModalRef = this.utilityService.openModal(modal);
  }
  ...
  onSubmitSearch(formAllData: any) {
    ...
    this.searchObject = {
      business_name: formAllData.businessName,
  ...
  getLinkedTaxpayerData() {
    ...
    this.apiUrl = `${environment.AUTHAPIURL}business/taxpayers`;
  ...
  generatePayeAssessment() {
    ...
    this.router.navigate(['/addemployee'], { state: { navigatedBusinessId: this.selectedBusinessId }});
    this.spinnerService.hide();
  }
