...
@Component({
  selector: "app-annualassessment",
  templateUrl: "./annualassessment.component.html",
  styleUrls: ["./annualassessment.component.scss"],
})
export class AnnualassessmentComponent implements OnInit {
  apiUrl: string;
  assessmentsData: any;
  dtOptions: any = {};
  ...
  roleID: string;
  title = "Direct Assessment - Annual Assessment Report";
  ...
  getAssessments(perpage, pageno) {
    ...
    //this.apiUrl = environment.AUTHAPIURL + "direct-assessments/list";
  ...
  pageChange(newPage: number) {
    this.assessmentsData = "";
    this.router.navigate(["/annualassessment"], { queryParams: { page: newPage } });
  ...
  public setItemsPerPage(event) {
    ...
    this.assessmentsData = "";
    this.router.navigate(["/annualassessment"]);
