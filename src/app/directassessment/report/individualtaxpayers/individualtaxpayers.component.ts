...
@Component({
  selector: "app-individualtaxpayers",
  templateUrl: "./individualtaxpayers.component.html",
  styleUrls: ["./individualtaxpayers.component.scss"],
})
export class IndividualtaxpayersComponent implements OnInit {
  apiUrl: string;
  individualsData: any;
  dtOptions: any = {};
  ...
  roleID: string;
  title = "Direct Assessmennt - Individual Tax Payer Report";
  ...
  getIndividuals(perpage, pageno) {
    ...
    this.httpClient
      ...
      .subscribe((data) => {
        console.log("individualsData: ", data);
        this.individualsData = data.response == null ? [] : data.response.data;
  ...
  pageChange(newPage: number) {
    this.individualsData = "";
    this.router.navigate(["/individualtaxpayers"], { queryParams: { page: newPage } });
  ...
  public setItemsPerPage(event) {
    ...
    this.individualsData = "";
    this.router.navigate(["/individualtaxpayers"]);
  ...
  onSubmitSearch(formAllData: any) {
    ...
    this.searchObject = {
      //first_name: formAllData.name,
      taxpayer_name: formAllData.name,
      // surname: formAllData.name,
      has_valid_email: formAllData.statusId,
      created_by_app_id: formAllData.appId,
      date_start:
