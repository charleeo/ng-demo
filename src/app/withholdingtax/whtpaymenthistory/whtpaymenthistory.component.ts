...
@Component({
  selector: 'app-whtpaymenthistory',
  templateUrl: './whtpaymenthistory.component.html',
  styleUrls: ['./whtpaymenthistory.component.css']
})
export class WhtpaymenthistoryComponent implements OnInit {
  apiUrl: string;
  ...
  getPaymentHistory(perpage, pageno) {
    ...
    this.apiUrl = `${environment.AUTHAPIURL}transactions/wht-list`;
  ...
  pageChange(newPage: number) {
    this.paymentHistoryData = "";
    this.router.navigate(["/whtpaymenthistory"], { queryParams: { page: newPage } });
  ...
  public setItemsPerPage(event) {
    ...
    this.paymentHistoryData = "";
    this.router.navigate(["/whtpaymenthistory"]);
