...
@Component({
  selector: 'app-assessmentreports',
  templateUrl: './assessmentreports.component.html',
  styleUrls: ['./assessmentreports.component.css']
})
export class AssessmentreportsComponent implements OnInit {
  ...
  pageChange(newPage: number) {
    this.assessmentsData = "";
    this.router.navigate(["/assessmentreports"], { queryParams: { page: newPage } });
  ...
  public setItemsPerPage(event) {
    ...
    this.assessmentsData = "";
    this.router.navigate(["/assessmentreports"]);
