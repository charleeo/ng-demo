...
@Component({
  selector: "app-corporatetaxpayerreports",
  templateUrl: "./corporatetaxpayerreports.component.html",
  styleUrls: ["./corporatetaxpayerreports.component.scss"],
})
export class CorporatetaxpayerreportsComponent implements OnInit {
  apiUrl: string;
  corporatesData: any;
  dtOptions: any = {};
  ...
  roleID: any;
  title = "PAYE - Corporate Tax Payer Report";
  ...
  getCorporates(perpage, pageno) {
    ...
    this.httpClient
      ...
      .subscribe((data) => {
        console.log("corporatesData: ", data);
        this.corporatesData = data.response == null ? [] : data.response.data;
  ...
  pageChange(newPage: number) {
    this.corporatesData = "";
    this.router.navigate(["/corporatereport"], { queryParams: { page: newPage } });
  ...
  public setItemsPerPage(event) {
    ...
    this.corporatesData = "";
    this.router.navigate(["/corporatereport"]);
  ...
  onSubmitSearch(formAllData: any) {
    ...
    this.searchObject = {
      ...
      has_valid_email: formAllData.emailStatus,
      created_by_app_id: formAllData.registeredFrom,
