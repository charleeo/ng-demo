...
@Component({
  selector: 'app-annualassessmentreports',
  templateUrl: './annualassessmentreports.component.html',
  styleUrls: ['./annualassessmentreports.component.css']
})
export class AnnualassessmentreportsComponent implements OnInit {
  apiUrl: string;
  assessmentsData: any;
  dtOptions: any = {};
  ...
  title = 'PAYE - Annual Assessment Report'
  taxOffice: any;
  taxTaxOffices: any;
  ...
  getAssessments(perpage, pageno) {
    ...
    //this.apiUrl = environment.AUTHAPIURL + 'annual-assessments/list';
    ...
    this.httpClient.post<any>(this.apiUrl, this.searchObject, { headers: reqHeader }).subscribe(data => {
      ...
      if (this.apiResponseMessage.includes('not')) {
        this.assessmentsData = [];
  ...
  pageChange(newPage: number) {
    this.assessmentsData = "";
    this.router.navigate(["/annualassessmentreports"], { queryParams: { page: newPage } });
  ...
  public setItemsPerPage(event) {
    ...
    this.assessmentsData = "";
    this.router.navigate(["/annualassessmentreports"]);
  ...
  onSubmitSearch(formAllData: any) {
    ...
    this.searchObject = {
      ...
      // company_name: formAllData.companyName,filedFromId
      revenue_board_approval_status: formAllData.statusId,
      app_id: formAllData.filedFromId,
  ...
  //       }
  //       else {
  //         dateString = `${dateObj.year}-${dateObj.month}-0${dateObj.day}`;
  //       }
  //     }
  //     else {
  //       dateString = null;
