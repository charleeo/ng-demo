...
@Component({
  selector: 'app-reassessmentreports',
  templateUrl: './reassessmentreports.component.html',
  styleUrls: ['./reassessmentreports.component.css']
})
export class ReassessmentreportsComponent implements OnInit {
  dtOptions: any = {};
  ...
  title = 'PAYE - Reassessment Report'
  roleID: string;
  ...
  ngOnInit(searchObj = null): void {
    ...
    if (searchObj == null || searchObj == '') {
      ...
      this.reassessmentsData = '';
      //this.getReassessments(searchObj);
  ...
  getReassessments(perpage, pageno) {
    ...
    this.httpClient.post<any>(this.apiUrl, this.searchObject, { headers: reqHeader }).subscribe(data => {
      ...
      this.reassessmentsData = data.response == null ? [] : data.response.data;
  ...
  pageChange(newPage: number) {
    this.reassessmentsData = "";
    this.router.navigate(["/reassessmentreports"], { queryParams: { page: newPage } });
  ...
  public setItemsPerPage(event) {
    ...
    this.reassessmentsData = "";
    this.router.navigate(["/reassessmentreports"]);
  ...
  onSubmitSearch(formAllData: any) {
    ...
    this.searchObject = {
      ...
      businesses_business_id: formAllData.business_id,
